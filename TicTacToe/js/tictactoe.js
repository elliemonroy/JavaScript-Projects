...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the wx1.png is placed in HTML
            select.style.backgroundImage = 'url("images/wx1.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to '0', the wo1.png is placed in HTML
            select.style.backgroundImage = 'url("images/wo1.png")';
        }
        ...
        function checkWinConditions() {
            ...
            //X 6, 4, 2 condition.
            else if (arrayIncludes('6X', '4X', '8X')) { drawWinLine(100, 508, 510, 90) }
            //X 0, 4, 8 condition.
            ...
            //9 squares are selected the code executes.
                ...
                //This function plays the drop tool sound.
                audio('./media/drop_tool.mp3');
       ...
       //This function plays purr sound. 
        audio('./media/purr.mp3');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition is smiliar to the one above.
    ...
    disableClick();
    //This line plays a guitar sound.
    audio('./media/solo.mp3');
